...

{
	...
	WebDriver driver;
	  ...
	  public void home() throws InterruptedException 
	  {
		    ...
		    File screenshotone = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		        ...
		        try {
		            FileUtils.copyFile(screenshotone, new File("C:\\Users\\Bhuvaneswari\\Desktop\\Folder 2\\home.png"));
	  ...
	  public void services() throws InterruptedException
	  {
	      ...
	      try {
	          FileUtils.copyFile(screenshottwo, new File("C:\\Users\\Bhuvaneswari\\Desktop\\Folder 2\\services.png"));
	      } catch (IOException io) 
	      {
	          System.out.println(io.getMessage());
	  }
	...
	File screenshotthree = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
	      ...
	      try {
	          FileUtils.copyFile(screenshotthree, new File("C:\\Users\\Bhuvaneswari\\Desktop\\Folder 2\\opensource.png"));
	      } catch (IOException io) 
	      {
	          System.out.println(io.getMessage());
	  }
	...
	File screenshotfour = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
	      ...
	      try {
	          FileUtils.copyFile(screenshotfour, new File("C:\\Users\\Bhuvaneswari\\Desktop\\Folder 2\\blog.png"));
	      } catch (IOException io) 
	      {
	          System.out.println(io.getMessage());
	  }
	  ...
	  public void team() throws InterruptedException
	  {
	      ...
	      try {
	          FileUtils.copyFile(screenshotfive, new File("C:\\Users\\Bhuvaneswari\\Desktop\\Folder 2\\team.png"));
	      } catch (IOException io) 
	      {
	          System.out.println(io.getMessage());
	  }
	  ...
	  try {
	      FileUtils.copyFile(screenshotsix, new File("C:\\Users\\Bhuvaneswari\\Desktop\\Folder 2\\careers.png"));
	  } catch (IOException io) 
	  {
	      System.out.println(io.getMessage());
	}
	  ...
	  try {
	      FileUtils.copyFile(screenshotseven, new File("C:\\Users\\Bhuvaneswari\\Desktop\\Folder 2\\contactus.png"));
	  } catch (IOException io) 
	  {
	      System.out.println(io.getMessage());
	}
